            ...
            <section class="sec-padding section-dark">
                <div class="pagenation-holder">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="uppercase text-light">Profil</h4>
                            </div>
                            <div class="col-md-6">
                                <ol class="breadcrumb">
                                    <li><a href="<?php echo site_url('home'); ?>">Home</a></li>
                                    <li>Profil</li>
                                    <li class="current"><a href="<?php echo site_url('profil/sejarah'); ?>">Sejarah</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="text-box">
                                    <div class="col-sm-12 nopadding">
                                        <div class="sec-title-container less-padding-4 text-left">
                                            <h2 class="font-weight-6 less-mar-1 line-height-5">Tentang Kami</h2>
                                            <div class="ce-title-line align-left"></div>
                                        </div>
                                    </div>
                                    <!--end title-->

                                    <p>Koperasi PRIMKOPPABRI Kabupaten Tegal merupakan bagian dari KSP PRIMKOPPABRI yang sudah berdiri di Indonesia sejak 36 tahun yang lalu yang didirikan olehperkumpulan koperasi purnawirawan ABRI di Sukmajaya kota administrative Depok , para pendirinya yaitu:
                                        <br>
                                        Adnan Supin (Purnawirawan ABRI)<br>
                                        Muhamad  Saiman (Purnawirawan ABRI)<br>
                                        Singa Rimbun (Purnawirawan ABRI)<br>
                                        Djodi Mochtar (Purnawirawan ABRI)<br>
                                        Darmodjo (Purnawirawan ABRI)<br>
                                        Ide dan inisiatif pendirian Koperasi PRIMKOPPABRI Kabupaten Tegalbermula dari keinginan untuk meningkatkan kesejahteraan annggota pada khususnya dan masyarakat pada umumnya. Sekaligus sebagai bagian yang tak terpisahkan dari tatanan perekonomian nasional yang demokratis dan berkeadilan.dengan tujuan mempermudahakses permodalan guna mengembangkan usahanya. </p>
                                    <!--end column-->
