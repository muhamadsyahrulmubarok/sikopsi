        ...
        <div class="site-wrapper">
                                            ...
                                            <ul class="nav navbar-nav">
                                                <li class="right active"> <a href="index.html">Home</a> <span class="arrow"></span>
                                                    <ul class="dm-align-2">
                                                        ...
                                                        <li class="active"> <a href="index3.html">Home Page 3</a></li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li> <a href="#">Portfolio Styles</a> <span class="arrow"></span>
                                                            <ul>
                                                                ...
                                                                <li> <a href="portfolio-mosaic.html"><i class="fa fa-angle-right"></i> &nbsp; Mosaic</a>
                                                                </li>
                                                        ...
                                                        <li> <a href="#">Portfolio Styles</a> <span class="arrow"></span>
                                                            <ul>
                                                                ...
                                                                <li> <a href="portfolio-nospace.html"><i class="fa fa-angle-right"></i> &nbsp; No
                                                                        Space</a> </li>
                                                                <li> <a href="portfolio-boxed-size.html"><i class="fa fa-angle-right"></i> &nbsp; Boxed
                                                                        Size</a> </li>
                                                                <li> <a href="portfolio-modern.html"><i class="fa fa-angle-right"></i> &nbsp; Modern</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li> <a href="#">Portfolio Single Page</a> <span class="arrow"></span>
                                                            <ul>
                                                                <li> <a href="portfolio-parallax.html"><i class="fa fa-angle-right"></i> &nbsp; Parallax
                                                                        Image</a> </li>
                                                                <li> <a href="portfolio-video.html"><i class="fa fa-angle-right"></i> &nbsp; Video
                                                                        Background</a> </li>
                                                                <li> <a href="portfolio-left-sidebar.html"><i class="fa fa-angle-right"></i> &nbsp; Left
                                                                        Sidebar</a> </li>
                                                ...
                                                <li class="mega-menu five-col"> <a href="shortcodes-carousel-sliders.html">Shortcodes</a> <span class="arrow"></span>
                                                    <ul>
                                                        <li> <a href="#">Shortcodes 1</a> <span class="arrow"></span>
                                                            <ul>
                                                                ...
                                                                <li><a href="shortcodes-breadcrumbs.html"><i class="fa fa-share" aria-hidden="true"></i>
                                                                        &nbsp; Breadcrumbs</a> </li>
                                                        ...
                                                        <li> <a href="#">Shortcodes 2</a> <span class="arrow"></span>
                                                            <ul>
                                                                <li><a href="shortcodes-content-boxes.html"><i class="fa fa-th" aria-hidden="true"></i>
                                                                        &nbsp; Content Boxes</a> </li>
                                                                <li><a href="shortcodes-data-tables.html"><i class="fa fa-table" aria-hidden="true"></i>
                                                                        &nbsp; Data Tables</a> </li>
                                                        ...
                                                        <li> <a href="#">Shortcodes 3</a> <span class="arrow"></span>
                                                            <ul>
                                                                ...
                                                                <li><a href="shortcodes-icon-lists.html"><i class="fa fa-list" aria-hidden="true"></i>
                                                                        &nbsp; Icon Lists</a> </li>
                                                                <li><a href="shortcodes-images.html"><i class="fa fa-picture-o" aria-hidden="true"></i>
                                                                        &nbsp; Images</a> </li>
                                                        ...
                                                        <li> <a href="#">Shortcode 5</a> <span class="arrow"></span>
                                                            <ul>
                                                                ...
                                                                <li><a href="shortcodes-sections.html"><i class="fa fa-square-o" aria-hidden="true"></i>
                                                                        &nbsp; Sections</a> </li>
                                                                ...
                                                                <li><a href="shortcodes-tooltips.html"><i class="fa fa-font" aria-hidden="true"></i>
                                                                        &nbsp; Tooltips</a> </li>
                                                                <li><a href="shortcodes-toogles.html"><i class="fa fa-toggle-on" aria-hidden="true"></i>
                                                                        &nbsp; Toogles</a> </li>
            ...
            <section class="section-side-image clearfix">
                <div class="img-holder col-md-12 col-sm-12 col-xs-12">
                    <div class="background-imgholder" style="background:url(http://via.placeholder.com/1500x1000);"><img class="nodisplay-image" src="http://via.placeholder.com/1500x1000" alt="" /> </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="col-md-12 text-center">
                                <h4 class="uppercase">Form with light background</h4>
                            </div>
                            <div class="clearfix"></div>
                                ...
                                <form method="get">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input id="id_anggota" class="input-1" type="text" placeholder="Masukan ID Anggota" name="id_anggota">
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            ...
                                            <input id="no" class="input-1" type="text" placeholder="Masukan Nomor Peminjaman" name="no">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <button class="btn btn-dark-3 btn-fullwidth uppercase" type="submit"><i class="fa fa-paper-plane"></i> Submit message</button>
                                        </div>
                                    </div>
                                    </br>
                                </form>
