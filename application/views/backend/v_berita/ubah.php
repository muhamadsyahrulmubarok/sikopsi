...
<head>
    <meta charset="utf-8" />
    <title>Ubah Berita - SIKOPSI</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="header-title">Form Ubah Berita</h4>

                    <form class="form-horizontal" action="<?php echo site_url('berita/update/') . $this->uri->segment(3); ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="judul_berita">Judul Berita</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="judul_berita" name="judul_berita" placeholder="Judul Berita" value="<?= $data['judul_berita']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="tgl_berita">Tanggal Berita</label>
                            <div class="col-sm-10">
                                <input type="date" id="tgl_berita" name="tgl_berita" class="form-control" placeholder="Tanggal Berita" value="<?= $data['tgl_berita']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="isi_berita">Isi Berita</label>
                            <div class="col-sm-10">
                                <textarea name="isi_berita" id="summernote-editor" placeholder="Isi Berita" class="form-control"><?= $data['isi_berita']; ?></textarea>
                            </div>
                        </div>
                        <style>
                            .kiri {
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <img src="<?php echo base_url('assets/img_berita/') . $data['img_berita']; ?>" alt="Foto Berita" width="120">
                                <input type="hidden" name="img_berita1" value="<?= $data['img_berita']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
