        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <a href="<?php echo site_url('anggota/tambah'); ?>"><button class="btn btn-primary">Tambah</button></a>
                        ...
                        <tbody class="text-center">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo site_url('anggota/ubah/') . $row['id_anggota']; ?>"><i class="mdi mdi-account-edit"></i></a> | <a href="javascript:void(0);" onclick="alert('<?= $row['id_anggota'] ?>', '<?= $row['nama_anggota'] ?>')"><i class="mdi mdi mdi-delete"></i></a>
                                    </td>
                                </tr>
                            <?php
                                $no++;
    ...
    <script>
        function alert(id, name) {
            ...
            Swal.fire({
                ...
                text: "Anda akan menghapus data anggota " + name,
                type: "warning",
                showCancelButton: !0,
                ...
                if (t.value) {
                    Swal.fire({
                        title: "Terhapus!",
                        text: "Data anggota " + name + " telah terhapus",
                        type: "success"
                    }).then(function() {
