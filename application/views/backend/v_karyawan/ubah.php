...
<head>
    <meta charset="utf-8" />
    <title>Ubah Karyawan - SIKOPSI</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="header-title">Form Ubah Karyawan</h4>

                    <form class="form-horizontal" action="<?php echo site_url('karyawan/update/') . $this->uri->segment(3); ?>" method="POST">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="nama_karyawan">Nama Karyawan</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nama_karyawan" name="nama_karyawan" placeholder="Nama Lengkap Karyawan" value="<?= $data['nama_karyawan']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="tgl_lahir">Tanggal Lahir</label>
                            <div class="col-sm-10">
                                <input type="date" id="tgl_lahir" name="tgl_lahir" class="form-control" placeholder="Tanggal Lahir" value="<?= $data['tgl_lahir']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="alamat">Alamat Karyawan</label>
                            <div class="col-sm-10">
                                <textarea id="alamat" name="alamat" class="form-control" placeholder="Alamat Karyawan"><?= $data['alamat']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="masa_kerja">Masa Kerja</label>
                            <div class="col-sm-10">
                                <input type="number" id="masa_kerja" name="masa_kerja" class="form-control" placeholder="Masa Kerja" value="<?= $data['masa_kerja']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="jabatan">Jabatan Karyawan</label>
                            <div class="col-sm-10">
                                <input type="text" id="jabatan" name="jabatan" class="form-control" placeholder="Jabatan Karyawan" value="<?= $data['jabatan']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="diangkat">Diangkat</label>
                            <div class="col-sm-10">
                                <input type="date" id="diangkat" name="diangkat" class="form-control" placeholder="Diangkat" value="<?= $data['diangkat']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="golongan">Golongan</label>
                            <div class="col-sm-10">
                                <input type="textarea" id="golongan" name="golongan" class="form-control" placeholder="Golongan" value="<?= $data['golongan']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
